...
ALTER TABLE "radius_sync"."artifacts" ADD CONSTRAINT "artifacts_session_id_sessions_session_id_fk" FOREIGN KEY ("session_id") REFERENCES "radius_sync"."sessions"("session_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."artifacts" ADD CONSTRAINT "artifacts_created_by_event_id_session_events_event_id_fk" FOREIGN KEY ("created_by_event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."event_artifacts" ADD CONSTRAINT "event_artifacts_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."event_artifacts" ADD CONSTRAINT "event_artifacts_artifact_id_artifacts_artifact_id_fk" FOREIGN KEY ("artifact_id") REFERENCES "radius_sync"."artifacts"("artifact_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_artifacts" ADD CONSTRAINT "file_artifacts_artifact_id_artifacts_artifact_id_fk" FOREIGN KEY ("artifact_id") REFERENCES "radius_sync"."artifacts"("artifact_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."link_artifacts" ADD CONSTRAINT "link_artifacts_artifact_id_artifacts_artifact_id_fk" FOREIGN KEY ("artifact_id") REFERENCES "radius_sync"."artifacts"("artifact_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."changes" ADD CONSTRAINT "changes_origin_device_id_devices_device_id_fk" FOREIGN KEY ("origin_device_id") REFERENCES "radius_sync"."devices"("device_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."projects" ADD CONSTRAINT "projects_origin_device_id_devices_device_id_fk" FOREIGN KEY ("origin_device_id") REFERENCES "radius_sync"."devices"("device_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."sessions" ADD CONSTRAINT "sessions_origin_device_id_devices_device_id_fk" FOREIGN KEY ("origin_device_id") REFERENCES "radius_sync"."devices"("device_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."sessions" ADD CONSTRAINT "sessions_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "radius_sync"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."agent_run_presentations" ADD CONSTRAINT "agent_run_presentations_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."agent_run_presentations" ADD CONSTRAINT "agent_run_presentations_agent_run_id_agent_runs_agent_run_id_fk" FOREIGN KEY ("agent_run_id") REFERENCES "radius_sync"."agent_runs"("agent_run_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."agent_run_state_updates" ADD CONSTRAINT "agent_run_state_updates_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."agent_run_state_updates" ADD CONSTRAINT "agent_run_state_updates_agent_run_id_agent_runs_agent_run_id_fk" FOREIGN KEY ("agent_run_id") REFERENCES "radius_sync"."agent_runs"("agent_run_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."agent_runs" ADD CONSTRAINT "agent_runs_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."agent_runs" ADD CONSTRAINT "agent_runs_session_id_sessions_session_id_fk" FOREIGN KEY ("session_id") REFERENCES "radius_sync"."sessions"("session_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."approval_decisions" ADD CONSTRAINT "approval_decisions_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."approval_decisions" ADD CONSTRAINT "approval_decisions_approval_request_event_id_approval_requests_event_id_fk" FOREIGN KEY ("approval_request_event_id") REFERENCES "radius_sync"."approval_requests"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."approval_requests" ADD CONSTRAINT "approval_requests_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."approval_requests" ADD CONSTRAINT "approval_requests_tool_call_event_id_tool_calls_event_id_fk" FOREIGN KEY ("tool_call_event_id") REFERENCES "radius_sync"."tool_calls"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."errors" ADD CONSTRAINT "errors_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."message_parts" ADD CONSTRAINT "message_parts_message_event_id_messages_event_id_fk" FOREIGN KEY ("message_event_id") REFERENCES "radius_sync"."messages"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."messages" ADD CONSTRAINT "messages_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."reasoning_summaries" ADD CONSTRAINT "reasoning_summaries_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."session_events" ADD CONSTRAINT "session_events_session_id_sessions_session_id_fk" FOREIGN KEY ("session_id") REFERENCES "radius_sync"."sessions"("session_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."session_events" ADD CONSTRAINT "session_events_source_client_instance_id_devices_device_id_fk" FOREIGN KEY ("source_client_instance_id") REFERENCES "radius_sync"."devices"("device_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."task_plans" ADD CONSTRAINT "task_plans_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."task_step_updates" ADD CONSTRAINT "task_step_updates_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."task_step_updates" ADD CONSTRAINT "task_step_updates_task_step_id_task_steps_task_step_id_fk" FOREIGN KEY ("task_step_id") REFERENCES "radius_sync"."task_steps"("task_step_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."task_steps" ADD CONSTRAINT "task_steps_plan_id_task_plans_plan_id_fk" FOREIGN KEY ("plan_id") REFERENCES "radius_sync"."task_plans"("plan_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."tool_calls" ADD CONSTRAINT "tool_calls_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."tool_progress_events" ADD CONSTRAINT "tool_progress_events_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."tool_progress_events" ADD CONSTRAINT "tool_progress_events_tool_call_event_id_tool_calls_event_id_fk" FOREIGN KEY ("tool_call_event_id") REFERENCES "radius_sync"."tool_calls"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."tool_results" ADD CONSTRAINT "tool_results_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."tool_results" ADD CONSTRAINT "tool_results_tool_call_event_id_tool_calls_event_id_fk" FOREIGN KEY ("tool_call_event_id") REFERENCES "radius_sync"."tool_calls"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_changes" ADD CONSTRAINT "file_changes_event_id_session_events_event_id_fk" FOREIGN KEY ("event_id") REFERENCES "radius_sync"."session_events"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_changes" ADD CONSTRAINT "file_changes_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "radius_sync"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_changes" ADD CONSTRAINT "file_changes_project_file_id_project_files_project_file_id_fk" FOREIGN KEY ("project_file_id") REFERENCES "radius_sync"."project_files"("project_file_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_changes" ADD CONSTRAINT "file_changes_tool_call_event_id_tool_calls_event_id_fk" FOREIGN KEY ("tool_call_event_id") REFERENCES "radius_sync"."tool_calls"("event_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_changes" ADD CONSTRAINT "file_changes_before_version_id_project_file_versions_version_id_fk" FOREIGN KEY ("before_version_id") REFERENCES "radius_sync"."project_file_versions"("version_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."file_changes" ADD CONSTRAINT "file_changes_after_version_id_project_file_versions_version_id_fk" FOREIGN KEY ("after_version_id") REFERENCES "radius_sync"."project_file_versions"("version_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."project_file_versions" ADD CONSTRAINT "project_file_versions_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "radius_sync"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "radius_sync"."project_file_versions" ADD CONSTRAINT "project_file_versions_project_file_id_project_files_project_file_id_fk" FOREIGN KEY ("project_file_id") REFERENCES "radius_sync"."project_files"("project_file_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "radius_sync"."project_files" ADD CONSTRAINT "project_files_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "radius_sync"."projects"("project_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
